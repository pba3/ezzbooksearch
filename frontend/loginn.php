<?php include('server.php'); 
      include("clienttest.php"); 
     //include ("testRabbitMQClient.php");
    // set_include_path("/rabbitmqphp_example"); ?>
...
<body background= "orange-white.jpg">
...
<form id="login" class="form-horizontal" action ="testRabbitMQClient.php" method="post" enctype="multipart/form-data" autocomplete="on">
